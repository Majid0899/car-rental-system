    ...
    <div class="container mx-auto px-4">
        <div class="flex justify-between items-center py-4">
            ...
            <div class="flex items-center space-x-2">
                ...
                <a href="/car-rental-system/index.php" class="text-xl font-bold">Car Rental System</a>
            </div>
            
            <!-- Navigation Links -->
            <div class="hidden md:flex items-center space-x-6">
                <a href="/car-rental-system/views/customer/available-cars.php" class="hover:text-gray-200 transition">
                    <i class="fas fa-cars mr-1"></i> Available Cars
                </a>
                
                <?php if ($isLoggedIn): ?>
                    <?php if ($userType === 'agency'): ?>
                        <a href="/car-rental-system/views/agency/add-car.php" class="hover:text-gray-200 transition">
                            <i class="fas fa-plus-circle mr-1"></i> Manage Cars
                        </a>
                        <a href="/car-rental-system/views/agency/view-bookings.php" class="hover:text-gray-200 transition">
                    ...
                    <div class="relative group">
                        ...
                        <div class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                            <div class="py-2">
                                ...
                                <a href="/car-rental-system/logout.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                ...
                <?php else: ?>
                    ...
                    <div class="relative group">
                        ...
                        <div class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                            <div class="py-2">
                                <a href="/car-rental-system/views/auth/customer-register.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                    <i class="fas fa-user mr-2"></i> As Customer
                                </a>
                                <a href="/car-rental-system/views/auth/agency-register.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
        ...
        <div id="mobile-menu" class="md:hidden hidden pb-4">
            <a href="/car-rental-system/views/customer/available-cars.php" class="block py-2 hover:text-gray-200">Available Cars</a>
